...
*/
	...
	__set_bit(KEY_GESTURE_RIGHT, g_InputDevice->keybit);
	__set_bit(KEY_GESTURE_LEFT, g_InputDevice->keybit);
	__set_bit(KEY_GESTURE_UP, g_InputDevice->keybit);
	__set_bit(KEY_GESTURE_DOWN, g_InputDevice->keybit);
	__set_bit(KEY_GESTURE_U, g_InputDevice->keybit);
	__set_bit(KEY_GESTURE_C, g_InputDevice->keybit);
	__set_bit(KEY_GESTURE_O, g_InputDevice->keybit);
	__set_bit(KEY_GESTURE_W, g_InputDevice->keybit);
	__set_bit(KEY_GESTURE_E, g_InputDevice->keybit);
	__set_bit(KEY_GESTURE_V, g_InputDevice->keybit);
	__set_bit(KEY_GESTURE_M, g_InputDevice->keybit);
	__set_bit(KEY_GESTURE_S, g_InputDevice->keybit);
	__set_bit(KEY_GESTURE_Z, g_InputDevice->keybit);
 #else
    input_set_capability(g_InputDevice, EV_KEY, KEY_POWER);
