...
#ifdef CONFIG_ENABLE_LEATHER_SHEATH_MODE
extern ssize_t DrvMainProcfsLeatherSheathModeRead(struct file *pFile, char __user *pBuffer, size_t nCount, loff_t *pPos);
extern ssize_t DrvMainProcfsLeatherSheathModeWrite(struct file *pFile, const char __user *pBuffer, size_t nCount, loff_t *pPos);
#endif //CONFIG_ENABLE_LEATHER_SHEATH_MODE
