...
//extern u16 g_hq_ctp_module_fw_version;
	...
	static unsigned char i_CTPM_FW[]=
	{
		...
		//#include "HQ_AW875_HX8527E44_TXD_A.0E.06_20160107.i"
		  //#include "HQ_AW875_HX8527E44_TXD_A.0E.07_20160114.i"
		  #include "HQ_ZAL875_HX8527E44_TXD_A.0E.B2_20160219.i"
...
static void himax_read_TP_info(struct i2c_client *client)
{
	...
	sprintf(g_tpd_module_name,"TXD");//wangshouping for ctp moudule
	//g_hq_ctp_module_fw_version = data[0];//wangshouping  for ctp version
	private_ts->vendor_config_ver = data[0];
	//read sensor ID
...
#endif
	//g_hq_ctp_module_fw_version = private_ts->vendor_config_ver;  //wangshouping add
    tpd->dev->id.version = private_ts->vendor_config_ver;
