...
static int LSM6DS3_ReadAccData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	else
	{
		...
		obj->data[LSM6DS3_AXIS_X] = (obj->data[LSM6DS3_AXIS_X]) *GRAVITY_EARTH_1000/1000; //NTC
		obj->data[LSM6DS3_AXIS_Y] = (obj->data[LSM6DS3_AXIS_Y]) *GRAVITY_EARTH_1000/1000;
		obj->data[LSM6DS3_AXIS_Z] = (obj->data[LSM6DS3_AXIS_Z]) *GRAVITY_EARTH_1000/1000;

	    
		obj->data[LSM6DS3_AXIS_X] = (obj->data[LSM6DS3_AXIS_X]) * obj->sensitivity/1000; //NTC
		obj->data[LSM6DS3_AXIS_Y] = (obj->data[LSM6DS3_AXIS_Y]) * obj->sensitivity/1000;
		obj->data[LSM6DS3_AXIS_Z] = (obj->data[LSM6DS3_AXIS_Z]) * obj->sensitivity/1000;
...
/* init step counter intterupt vars  --add by liaoxl.st 7.28.2015  end */
	...
	g_gsensor_name = LSM6DS3_ACC_DEV_NAME;
