...
//phb modified for take 3s to resume 2016.06.01 start
void pm_mag_enable_data(int handle, int enable)
{
	if (1 == enable) {
		if (1 == handle)
			mag_enable_data(1, 1);
...
EXPORT_SYMBOL(pm_mag_enable_data);
//phb modified for take 3s to resume 2016.06.01 end
/*----------------------------------------------------------------------------*/
