...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	*/
	...
	{0xBA, 6,{0x62,0x03,0x68,0x7B,0xB2,0xC0}},
           
	{0xB1,10,{0x50,0x12,0x72,0x09,0x33,0x54,0x91,0x31,0x6B,0x2F}},
           
	{0xB2, 6,{0x00,0x80,0x64,0x0E,0x0D,0x2F}},
           
	{0xB4,21,{0x73,0x74,0x73,0x74,0x73,0x74,0x01,0x15,0x84,0x35,0x40,0x1F,0x73,0x74,0x73,0x74,0x73,0x74,0x01,0x0C,0x86}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.horizontal_frontporch				= 0x3C;
		params->dsi.horizontal_active_pixel				= FRAME_WIDTH;
	...
	params->dsi.lcm_esd_check_table[0].para_list[2] = 0x04;//0x06;
	...
	params->dsi.lcm_esd_check_table[2].para_list[0] = 0x5;//0f
	params->dsi.lcm_esd_check_table[2].para_list[1] = 0x18;	//f0
...
LCM_DRIVER hx8394f_dsi_vdo_hd720_txd_zal875_lcm_drv = 
{
    .name			= "hx8394f_boe_hd720_txd",
