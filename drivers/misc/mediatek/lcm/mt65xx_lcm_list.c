...
LCM_DRIVER *lcm_driver_list[] = {
	...
	&lcm_common_drv,
#else
#if defined(ILI9881C_DSI_VDO_HD720_DJ_ZAL875)
    &ili9881c_dsi_vdo_hd720_dj_zal875_lcm_drv,
#endif

#if defined(ILI9806E_DSI_VDO_DJ_FWVGA_ZAL1066)
    &ili9806e_dsi_vdo_dj_fwvga_drv,
#endif

#if defined(ILI9806E_DSI_VDO_BY_FWVGA_ZAL1066)
    &ili9806e_dsi_vdo_by_fwvga_drv,
#endif

#if defined(OTM8019_FWVGA_BY_HSD)
    &otm8019_fwvga_by_hsd_drv,
#endif

#if defined(HX8394F_DSI_VDO_HD720_TXD_ZAL875)
    &hx8394f_dsi_vdo_hd720_txd_zal875_lcm_drv,
#endif
