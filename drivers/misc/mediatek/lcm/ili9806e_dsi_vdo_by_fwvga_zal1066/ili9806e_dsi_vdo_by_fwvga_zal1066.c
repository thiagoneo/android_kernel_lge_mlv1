...
{
#ifdef BUILD_LK
    printf("ili9806_by init start \n");
#else
    printk("ili9806_by inint start \n");
#endif
    SET_RESET_PIN(1);
    MDELAY(10); //20
    SET_RESET_PIN(0);
...
#ifdef BUILD_LK
    printf("ili9806_by init end \n");
#else
    printk("ili9806_by inint end \n");
#endif
}
...
static unsigned int lcm_compare_id(void)
{
	...
	printf("%s, LK DJ_HSD ILI9806E debug: ILI9806E_BY id = 0x%x\n", __func__, id);
	...
	if(LCM_ID_ILI9806E == id) {
		...
		printf("ili9806_by compare id value is = %d\n",lcm_id);
...
LCM_DRIVER ili9806e_dsi_vdo_by_fwvga_drv = 
{
	.name		= "ili9806e_by_hsd",
